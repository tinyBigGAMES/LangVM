{===============================================================================
 ...
 -------------------------------------------------------------------------------
  ...
  LangVM.ZigBuild.Targets - Supported target architectures, OSes, and ABIs.
  ...
  Regenerate with _gentargets.cmd (runs `zig targets` and re-emits this unit).

  Dependencies: none
===============================================================================}

unit LangVM.ZigBuild.Targets;
